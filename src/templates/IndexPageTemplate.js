          ...
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              <span class="text-gray-600">
                New Products Avaliable! <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Shop Now <span aria-hidden="true">&rarr;</span></a>
              </span>
            </div>
          </div>
          <div>
            <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Do you want to discover or reignite love in your life?</h1>
            <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Learn the secrets on how to make any man (friend, ex, boyfriend, or husband) fall deeply and madly in love with you, for the first time or all over again.</p>
...
Learn the secrets on how to make any man (friend, ex, boyfriend, or husband) fall deeply and madly in love with you, for the first time or all over again.</p>
...
<div class="relative bg-white py-24 sm:py-32 lg:py-40">
  <div class="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
    ...
    <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Explore the Six Secret Keys You Need to Attract Any Man</p>
    ...
    <div class="py-12 px-4 sm:px-6 md:flex md:flex-col md:border-r md:border-indigo-900 md:py-16 md:pl-0 md:pr-10 lg:pr-16">
      ...
      <blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
        <div class="relative text-lg font-medium text-white md:flex-grow">
          ...
          <p class="relative">
Amanda, thank you for being a guide. This book taught me what I deserve in a relationship and how I should be treated!
Amanda brings the brutal honesty, compassion, and bad bitch energy that every woman should learn to embody. Get ready!</p>
        </div>
        <footer class="mt-8">
    ...
    <div class="border-t-2 border-pink-50 py-12 px-4 sm:px-6 md:border-t-0 md:border-l md:py-16 md:pr-0 md:pl-10 lg:pl-16">
      ...
      <blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
        <div class="relative text-lg font-medium text-white md:flex-grow">
          ...
          <p class="relative">This book opened my heart to communicate with men in a productive, feminine way that doesn’t emasculate my partner, but rather inspires him to show up as a divine masculine king. 

I bought this program to get back a man I’d been dating for 2 years, but reading this book made me realize that I deserve so much better.</p>
        </div>
        <footer class="mt-8">
          <div class="flex items-start">
            <div class="inline-flex flex-shrink-0 rounded-full border-2 border-white">
